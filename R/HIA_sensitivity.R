#-----------------------------------------------------------------------------#
#                 Sensitivity analysis: HIA with alternative ERF              #
#-----------------------------------------------------------------------------#
...
set.seed(1234)
point_RR10 <- 1.021
sim_RR10 <- exp(rnorm(200, mean = log(point_RR10), sd = log(1.024/1.018)/(qnorm(0.975)*2)))
...
write_csv(attr_nuts, paste0(pathroot, "data/processed/attributable_nuts_sensitivity.csv"))
...
write_csv(attr_country, paste0(pathroot, "data/processed/attributable_country_sensitivity.csv"))
...
write_csv(attr_euro, paste0(pathroot, "data/processed/attributable_euro_sensitivity.csv"))